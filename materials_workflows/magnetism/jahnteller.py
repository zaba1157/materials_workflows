...
class JahnTellerAnalyzer:
        ...
        self.spin_configs = {
            "oct":
                {  # key is number of d electrons
                    ...
                    4: {"high": {"e_g": 1, "t_2g": 3}, "low": {"e_g": 0, "t_2g": 4},
                        "default": "high"},  # strong high, weak low
                    5: {"high": {"e_g": 2, "t_2g": 3}, "low": {"e_g": 0, "t_2g": 5},
                        "default": "low"},  # no high, weak low
                    6: {"high": {"e_g": 2, "t_2g": 4}, "low": {"e_g": 0, "t_2g": 6},
                        "default": "high"},  # weak high, no low
                    7: {"high": {"e_g": 2, "t_2g": 5}, "low": {"e_g": 1, "t_2g": 6},
                        "default": "low"},  # weak high, strong low
    ...
    def is_jahn_teller_active(self, structure, calculate_valences=True):
        ...
        try:
            analysis = self.get_analysis(structure,
                                         calculate_valences=calculate_valences)
